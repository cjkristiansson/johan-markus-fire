...
if "pension_indb_j" not in st.session_state: st.session_state["pension_indb_j"] = 7200
...
def simulate_solo_fire_plan(scenario_name, boligpris, udbetaling_j, ydelse_default, ydelse_key, ejerudgifter_standard):
    ...
    with col_inp:
        ...
        # Start_inv_md_j bruges KUN visuelt til at vise "Mdl. opsparing i År 0". Den lægges IKKE længere til fremtiden.
